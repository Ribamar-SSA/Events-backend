@extends('layouts.main') <!-- Usa o layout principal -->

@section('title', 'Editar Evento') <!-- Preenche a seção de título -->

@section('content') <!-- Preenche o conteúdo da página -->
<div class="container mx-auto mt-8 p-4">
    <h1 class="text-3xl font-bold mb-6 text-center">Crie o seu evento</h1>
    <form action="{{ route('events.update', ['id' => $event->id]) }}"
        method="POST"
        ...
        <div class="mb-4">
            ...
            <input type="text" id="title" name="title" placeholder="Título do evento" value="{{ $event->title }}"
        ...
        <div class="mb-4">
            ...
            <input type="text" id="speaker" name="speaker" placeholder="Nome do orador" value="{{ $event->speaker }}"
                class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700">
        </div>

        <!-- Descrição -->
        <textarea id="description" name="description" placeholder="Descrição do evento"
            class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 h-24 resize-none">{{ $event->description }}</textarea>
        ...
        <div class="mb-4">
            ...
            <input type="text" id="location" name="location" placeholder="Local do evento" value="{{ $event->location }}"
                class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700">
        </div>
        ...
        <div class="mb-4">
            ...
            <input type="number" id="capacity" name="capacity" placeholder="Número de vagas" value="{{ $event->capacity }}"
                class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700">
        </div>
        ...
        <div class="mb-4">
            ...
            <input type="text" id="category" name="category" placeholder="Ex: Tecnologia, Negócios..." value="{{ $event->category }}"
                class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700">
        </div>
